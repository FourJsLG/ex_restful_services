...
#
################################################################################
#+ This module implements order class information handling
#+
#+ This code uses the 'officestore' database tables.
#+ Order input, query and list handling functions are defined here.
#+

IMPORT util
SCHEMA officestore

&include "orderTypes.inc"
...
PRIVATE FUNCTION updateRecordById(thisData STRING)
    ...
    EXECUTE recordUpdate USING thisRecord.billfirstname, thisRecord.billlastname, thisRecord.orderid -- a list from the record thisDat.orderid
...
PRIVATE FUNCTION deleteRecordById(thisData STRING)
    ...
    EXECUTE recordDelete USING thisRecord.orderid
    LET stat = SQLCA.SQLCODE
