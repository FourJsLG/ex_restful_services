...
FUNCTION getRecords()
    ...
    ELSE LET sqlStatement = SFMT("%1 %2 '%3'", sqlStatement, " AND catid LIKE ", mQuery.id) END IF
...
#+ Method: init()
#+
#+ Initialize the category record storage
#+
...
#+
#+ Update the given category record in the data source.
#+
...
#+
#+ Performs tasks to insert category record information into the datasource.
#+
...
#+
#+ Creates the given category record in the data source.
#+
